...
class Main(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for Paginas in (Registro, Login, App, Relajate,  Duermete, Alegrate,  Regresa):
...
class App(tk.Frame):
    ...
    # Creación de botones
        ...
        self.button = tk.Button(self,  image = self.foto, borderwidth=0, highlightthickness=0, command = (lambda: self.cambiar_Duermete(controller)))
        ...
        self.button2 = tk.Button(self,  image = self.foto2, borderwidth=0, highlightthickness=0,  command = (lambda: self.cambiar_Pagina1(controller)))
        ...
        self.button3 = tk.Button(self,  image = self.foto3, borderwidth=0, highlightthickness=0,  command = (lambda: self.cambiar_Alegrate(controller)))
        ...
        self.button4 = tk.Button(self,  image = self.foto4, borderwidth=0, highlightthickness=0, command = (lambda: self.cambiar_Regresa(controller)))
